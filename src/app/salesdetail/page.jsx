    ...
    <div className="bg-gray-100 flex flex-col justify-center items-center h-screen">
      ...
      {detailSales.length > 0 ? (
        ...
        {detailSales.map((detail) => (
          <tr key={detail.id} className="bg-white hover:bg-cyan-100 cursor-pointer duration-100"
          >
        ...
        <p className="text-2sm font-bold text-center text-black">No tiene campos</p>
      )}
    </div>
  );
}
