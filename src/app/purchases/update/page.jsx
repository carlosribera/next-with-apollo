...
const UPDATE_PURCHASES = gql`
  mutation updatePurchase($id: ID!, $purchaseInput: PurchaseInput!) {
    updatePurchase(purchaseInput: $purchaseInput) {
      idSupplier
      precioTotal
    }
  }
...
const UPDATE_DETAILPURCHASES = gql`
  mutation updateDetailPurchase(
    $id: ID!
    $detailPurchaseInput: DetailPurchaseInput!
  ) {
    updateDetailPurchase(detailPurchaseInput: $detailPurchaseInput) {
      idProducto
      cantidad
      precioProducto
    }
...
export default function UpdatePurchase() {
  ...
  const [updatePurchase, { loading: loadingPurchase, error: errorPurchase }] =
    useMutation(UPDATE_PURCHASES, {
  ...
  const [
    ...
    { loading: loadingDetailPurchase, error: errorDetailPurchase },
  ] = useMutation(UPDATE_DETAILPURCHASES, {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Error creando la compra", err.message);
      alert(`Error creando la compra: ${err.message}`);
    }
  };
